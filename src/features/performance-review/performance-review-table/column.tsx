...
export const performance_review_columns: ColumnDef<PerformanceReviewListItem>[] =
  [
    {
      header: "Sr.No.",
      accessorKey: "sr_no",
...
export const performance_review_action_column: ColumnDef<PerformanceReviewListItem> =
  {
    header: "Actions",
    accessorKey: "actions",
    cell: (props) => {
